<template>
	<view class="content">
		...
		<cc-rightPopup :isSingleSel="true" :pop-show="popShow" :colors="colors" :classList="classList"
			@change="changeClick" @sureClick="sureClick" @hideClick="hideright"></cc-rightPopup>
	</view>
</template>
